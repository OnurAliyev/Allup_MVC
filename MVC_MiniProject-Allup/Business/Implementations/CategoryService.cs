    ...
    public class CategoryService : ICategoryService
    {
        ...
        public async Task UpdateAsync(Category category)
        {
            ...
            if(category.ImageFile is not null)
            {
                ...
                FileManager.DeleteFile(_env.WebRootPath, "uploads/sliders", existCategory.ImageUrl);
                category.ImageUrl = category.ImageFile.SaveFile(_env.WebRootPath, "uploads/sliders");
            }
